...
const GrowingIridescentTree = () => {
  ...
  useEffect(() => {
    ...
    const generateNewBranch = (parentBranch: any, parentProgress: number) => {
      // Instead of random direction changes, the angle will be determined by mouse position each frame.
      // We still need a "baseAngle" for the branch, but it won't define growth direction alone.
      ...
      return {
        ...
        angle: parentBranch.angle, // Will be updated according to mouse each frame
    ...
    const updateDirections = () => {
      // Update all branch angles towards the mouse position
